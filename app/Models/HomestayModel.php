...
class HomestayModel extends Model
{
    ...
    protected $allowedFields    = [
        'id', 'name', 'address', 'contact_person', 'open', 'close', 'ticket_price', 'description', 'status', 'homestay_status', 'video_url', 'geom'
    ];
    ...
    public function get_list_homestay()
    {
        ...
        $columns = "{$this->table}.id,{$this->table}.name,{$this->table}.address,{$this->table}.contact_person,{$this->table}.open,{$this->table}.close,{$this->table}.video_url,{$this->table}.ticket_price,{$this->table}.homestay_status,{$this->table}.description";
    ...
    {
        $columns = "{$this->table}.id,{$this->table}.name,{$this->table}.address,{$this->table}.contact_person,{$this->table}.open,{$this->table}.close,{$this->table}.video_url,{$this->table}.ticket_price,{$this->table}.homestay_status";
        $query = $this->db->table($this->table)
            ->select("{$columns}")
            ->where('id', $id)
            ->get();
    ...
    public function get_homestay_by_id_custom($id = null)
    {
        ...
        $query = $this->db->table($this->table)
            ...
            ->groupBy("unit_homestay.price, {$this->table}.id,{$this->table}.name,{$this->table}.address,{$this->table}.contact_person,{$this->table}.open,{$this->table}.close,{$this->table}.video_url,{$this->table}.ticket_price,{$this->table}.homestay_status,{$this->table}.description")
            ->get();
        return $query;
    }
